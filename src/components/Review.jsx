    ...
    <section className="container mx-auto mb-8 mt-12" id="review">
      ...
      >
        <motion.p
          ...
          className="mb-19 text-3xl font-light text-center leading-normal tracking-tight lg:mx-40 lg:mt-40 lg:text-[3.5rem]"
        >
          {REVIEW.content}
        </motion.p>
        <motion.div
        ...
        >
          ...
          <div className="tracking-tighter">
            <h6>{REVIEW.name}</h6>
            <p className="text-small text-neutral-500">{REVIEW.profession}</p>
          </div>
        </motion.div>
      </motion.div>
      <motion.div
